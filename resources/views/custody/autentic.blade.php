            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    ...
                    <p class="text-lead text-white">
                        {{ __('No estas autenticado en el sistema este registro solo debe hacerse una vez') }}
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="card z-index-0">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('/custody')}}" method="POST" role="form text-left">
                            ...
                            <div class="mb-3">
                                <span>Fecha de expedicion del documento</span>
                                <div class="@error('name') border border-danger rounded-3  @enderror">
                                    <input wire:model="dateExpedition" id="dateExpedition" name = "dateExpedition" type="date" class="form-control" placeholder="Fecha de expedición del documento"
                                        aria-label="Name" aria-describedby="email-addon">
                                </div>
                                @error('name') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="@error('name') border border-danger rounded-3  @enderror">
                                    <input wire:model="dateBirth" id="dateBirth" name = "dateBirth" type="date" class="form-control" placeholder="Fecha de nacimiento"
                                        aria-label="Name" aria-describedby="email-addon">
                                </div>
                                @error('name') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                            ...
                            {{-- <div class="mb-3">
                                <span>Ingresa el codigo OTP que te llevo al correo</span>
                                <div class="@error('name') border border-danger rounded-3  @enderror">
                                    <input wire:model="name" type="text" id="otp" name = "otp" class="form-control" placeholder="Codigo OTP"
                                        aria-label="Name" aria-describedby="email-addon">
                                </div>
                                @error('name') <div class="text-danger">{{ $message }}</div> @enderror
                            </div> --}}
                            ...
                            {{-- <div class="form-check form-check-info text-left">
                                ...
                                <label class="form-check-label" for="flexCheckDefault">
                                    {{ __('Acepto los ') }} <a href="javascript:;"
                                        class="text-dark font-weight-bolder">{{ __('Terminos y condiciones') }}</a>
                                </label>
                            </div> --}}
